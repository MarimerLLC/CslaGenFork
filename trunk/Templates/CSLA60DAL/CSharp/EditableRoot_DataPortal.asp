...
if (UseNoSilverlight() && (CurrentUnit.GenerationParams.TargetIsCsla45 || CurrentUnit.GenerationParams.TargetIsCsla50 || CurrentUnit.GenerationParams.TargetIsCsla60) && createRunLocalDp &&
...
if (UseNoSilverlight() && (CurrentUnit.GenerationParams.TargetIsCsla40 ||
    ((CurrentUnit.GenerationParams.TargetIsCsla45 || CurrentUnit.GenerationParams.TargetIsCsla50 || CurrentUnit.GenerationParams.TargetIsCsla60) && (!createRunLocalDp || CurrentUnit.GenerationParams.SilverlightUsingServices))))
{
    %>
<!-- #include file="DataPortalCreate.asp" -->
<%
